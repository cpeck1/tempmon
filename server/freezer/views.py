from freezer.models import Freezer
from freezer.serializers import FreezerSerializer
...
class FreezerList(APIView):
    ...
    def get(self, request, format=None):
        freezer = Freezer.objects.all()
        serializer = FreezerSerializer(freezer, many=True)
